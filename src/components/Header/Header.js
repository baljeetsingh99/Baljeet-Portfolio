      ...
      <div class="container text-center" id="home">
        <div class="row">
          <div class="col-md-6 order-2 order-md-1">
            <h1 className="heading">Hey, I'm Baljeet Singh</h1>
            <h4 className="heading-description mt-md-4 mb-md-3">
              A JAVA Full Stack Developer Passionate About Coding. Always ready to try Hands-on New and
              Emerging Technologies.
            </h4>
            <a
              href={require('./../../assests/BaljeetMp.pdf')}
              download="Baljeet Singh Resume">
